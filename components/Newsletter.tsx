...
export default function Newsletter() {
  return (
    <div className="relative isolate overflow-hidden py-16 sm:py-24 lg:py-32 bg-pink-400">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <p className="mt-4 text-lg leading-8 text-gray-300">
              Get The latest and greatest beauty and health tips and tricks all
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              ...
              <dd className="mt-2 leading-7 text-cyan-400 font-semibold">
                The Dates may vary based on current trends and tricks, only
            ...
            <div className="flex flex-col items-start">
              ...
              <dd className="mt-2 leading-7 text-cyan-400 font-semibold">
                Our system works to never &quot;spam&quot; or send
                filler/low-effort content
              </dd>
            </div>
          </dl>
        </div>
